...
def convert_coco_dection_dataset(imgs_dir, annotations_filepath, output_filepath, shuffle_img = True ):
    ...
    Args:
        ...
        output_filepath: file path of tfrecord file
...
def main(_):
    ...
    convert_coco_dection_dataset(imgs_dir, annotations_filepath, FLAGS.output_filepath, shuffle_img=FLAGS.shuffle_imgs)
